    ...
    static function resolve_url($url, $protocol, $host, $base_path, Dompdf $dompdf)
    {
        ...
        try {
            ...
            if (!is_readable($resolved_url) || !filesize($resolved_url)) {
                ...
                // Known image type
                if ($width && $height && in_array($type, ["gif", "png", "jpeg", "jpg", "bmp", "svg"])) {
...
if (file_exists(realpath(__DIR__ . "/../../lib/res/LOGO.jpg"))) {
    Cache::$broken_image = realpath(__DIR__ . "/../../lib/res/LOGO.jpg");
}